...
const education = [
  {
    ...
    detail: 'Graduate specialization in data-driven supply chain management, analytics methods, and operations strategy.',
          ...
          {education.map((edu, i) => (
            <Reveal key={edu.school} delay={i * 0.12}>
              ...
              >
                ...
                <div className="font-mono text-[9px] tracking-widest3 uppercase text-ink-400 mb-8">
                  {edu.period}
                </div>
                ...
                <p className="font-body font-light text-ink-200 text-sm leading-relaxed mb-8" style={{ lineHeight: 1.85 }}>
                  {edu.detail}
                </p>

                <div className="flex items-center gap-2">
                  <div className="w-1 h-1 rounded-full bg-gold opacity-60" />
                  <span className="font-mono text-[9px] tracking-widest text-ink-400 uppercase">{edu.location}</span>
                </div>
              </motion.div>
            </Reveal>
          ))}
