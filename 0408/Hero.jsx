    ...
    >
      <motion.div style={{ scale }} className="absolute inset-0">
        <div
          ...
          style={{
            background: 'radial-gradient(ellipse 70% 60% at 50% 55%, rgba(196,169,110,0.07) 0%, transparent 70%)',
          }}
        />
        <div
          ...
          style={{
            backgroundImage: `
              linear-gradient(rgba(196,169,110,0.6) 1px, transparent 1px),
              linear-gradient(90deg, rgba(196,169,110,0.6) 1px, transparent 1px)
            `,
      ...
      >
        ...
        <motion.p
          ...
          className="font-body font-light text-ink-200 mb-14 max-w-lg mx-auto"
          style={{ fontSize: '1.05rem', lineHeight: 1.75, letterSpacing: '0.01em' }}
        >
        ...
        >
          <button
            ...
            className="font-body text-xs tracking-widest2 uppercase px-8 py-3.5 bg-gold text-ink-950 hover:bg-gold-light transition-all duration-300"
          >
            View My Work
          </button>
          <a
            href="mailto:0906yuliang@gmail.com"
            className="font-body text-xs tracking-widest2 uppercase px-8 py-3.5 border border-ink-500 text-ink-100 hover:border-gold hover:text-gold transition-all duration-300"
          >
            Get In Touch
          </a>
        </motion.div>
